class Events::UnpublishedEventsController < ApplicationController
  ...
  def flag
    ...
    redirect_to unpublished_events_path, notice: "#{@event.title} has been flagged as spam, and #{@event.organizers.first.display_name} has been flagged as a spammer so any other events they create will immediately be flagged as spam."
  end
