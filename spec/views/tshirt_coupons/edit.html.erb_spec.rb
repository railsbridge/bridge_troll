...
describe "tshirt_coupons/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit tshirt_coupon form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => tshirt_coupon_path(@tshirt_coupon), :method => "post" do
