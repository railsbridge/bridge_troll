...
class InitSchema < ActiveRecord::Migration[4.2]
  def up
    ...
    add_index 'event_sessions', %w[event_id name], name: 'index_event_sessions_on_event_id_and_name', unique: true
    ...
    add_index 'regions_users', %w[region_id user_id], name: 'index_regions_users_on_region_id_and_user_id', unique: true
